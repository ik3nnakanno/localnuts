...
if(isset($_POST['update_food'])){
   ...
   if($update_query){
      ...
      header('location:update_chi.inc.php');
   }else{
...
<body id="body-main">
    ...
    <main>
        ...
        <?php
    $select_products = mysqli_query($conn, "SELECT * FROM `food`WHERE category_id = 1");
    if(mysqli_num_rows($select_products) > 0){
       while($row = mysqli_fetch_assoc($select_products)){
        ...
        <form>
                ...
                <button option-btn><a href="update_chi.inc.php?id=<?php echo $row['food_id']; ?>">Update</a></button>
...
<div class="edit-form-container">  
   ...
   ?>
    ...
    <script>
        ...
        window.location.href = 'update_chi.inc.php';
        };
    </script>